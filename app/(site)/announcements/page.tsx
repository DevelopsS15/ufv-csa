...
function BasicAnnouncementDisplay({
  ...
  return (
    ...
    >
      <div className="w-full sm:max-w-48 md:max-w-64 bg-slate-300 dark:bg-slate-950/50 rounded-t-md sm:rounded-l-md flex items-center justify-center">
        {announcement.image ? (
          <Image
      ...
      <div className="flex-1 p-3 flex flex-col h-full">
        <div className="text-lg sm:text-xl font-bold">{announcement.title}</div>
